...
export default function Transactions() {
  ...
  const loadTxns = async () => {
    ...
    const { data } = await supabase.functions.invoke('wallet', {
      body: { action: 'get_transactions', user_id: user.user_id },
    });
  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-6">
      <h1 className="text-2xl font-extrabold">Lịch sử giao dịch</h1>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Số dư: {txn.balance_before} → {txn.balance_after}</p>
                  </div>
                </div>
